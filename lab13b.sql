-- Задание №5 Разработайте пакет TEACHERS, содержащий процедуры и функции:
...
-- Задание №6 Разработайте анонимный блок и продемонстрируйте выполнение процедур и функций пакета TEACHERS.
BEGIN
    DBMS_OUTPUT.PUT_LINE('');
